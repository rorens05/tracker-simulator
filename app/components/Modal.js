...
import {Text, TouchableOpacity, View, Dimensions, Image, ImageBackground} from 'react-native';
        ...
        <ImageBackground source={status ? blueLines : redLines} style={{height: 350, width: 600, backgroundColor: '#FFF', borderRadius: 25}}>
          <View style={{flexDirection: 'row', padding: 20, justifyContent: 'space-between'}}>
            <View style={{width: 120}}>
              <Image source={sbuLogo} resizeMode='contain' style={{width: 70, height: 70, borderRadius: 35}} />
            </View>
            <View style={{height: 160, justifyContent: 'flex-end'}}>
              <Image source={status ? blueUser : redUser} resizeMode='contain' style={{width: 110, height: 110}} />
            </View>
            <View style={{width: 120}}>
              <Image source={ontraqLogo} resizeMode='contain' style={{width: 120, height: 50}} />
            </View>
          </View>
